    ...
    <form action="alumno.php" method="POST" class="bg-white py-4 needs-validation" novalidate>
        ...
        <div class="px-4">
            <div>
                ...
                <p>Para realizar la búsqueda de un alumno es necesario llenar el siguiente formulario.</p>
            </div>
            <div class="col-md-12 my-2">
                ...
                <div class="invalid-feedback">
                    El nombre es obligatorio y debe tener más de un carácter.
                </div>
            </div>
            <div class="col-md-12 my-2">
                ...
                <div class="invalid-feedback">
                    El apellido paterno es obligatorio y debe tener más de un carácter.
                </div>
            </div>
            <div class="col-md-12 mt-2">
                <label for="ap_m" class="form-label fw-semibold">Apellido Materno:</label>
                <input id="ap_m" type="text" name="ap_m" minlength="2" placeholder="Apellido materno" required class="form-control">
                <div class="invalid-feedback">
                    El apellido materno es obligatorio y debe tener más de un carácter.
                </div>
            </div>
