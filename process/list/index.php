...
<div class="col-10 col-md-8 col-lg-6 col-xl-4 shadow-sm my-4">
    <form action="confirmacion.php" method="POST" class="bg-white py-4 needs-validation" novalidate>

        <div class="px-4">
            <div>
                <h1 class="fs-2 text-center">Asistencia</h1>
                <p>Registra tu asistencia al evento de egresados 2022.</p>
            </div>
